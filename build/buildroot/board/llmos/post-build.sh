...
NODE_ARCH="x64"
NODE_URL="https://nodejs.org/dist/v${NODE_VERSION}/node-v${NODE_VERSION}-linux-${NODE_ARCH}-musl.tar.xz"
NODE_SHA256="https://nodejs.org/dist/v${NODE_VERSION}/SHASUMS256.txt"
